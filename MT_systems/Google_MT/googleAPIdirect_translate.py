...
from googleAPI import GoogleDirect
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Perform Direct Translation From Source Language to Target Language With Google Translate API')
    ...
    if args.to_console == True:
        with open(args.file) as txt_file:
            for line in txt_file:
                src = line.strip().replace(" ' ", "'").replace(" .", ".").replace(" ?", "?").replace(" !", "!")\
